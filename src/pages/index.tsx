  ...
  return (
    <div className='container mx-auto font-Roboto'>
      <div className="flex h-screen">
        <div className="flex justify-between p-12 py-36 h-full items-center">
      ...
      <p className="text-3xl font-medium text-gray-700">Serviços disponiveis</p>
      <div className="flex flex-row">
        <Link href={'/login'} passHref>
          <div className="flex-col basis-2/4 p-10 hover:cursor-pointer">
